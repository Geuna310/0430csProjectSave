...
import WarehouseDelete from "../../pages/admin/Warehouse/WarehouseDelete";
import WarehouseAddition from "../../pages/admin/Warehouse/WarehouseAddition";
    ...
    <Routes>
      {isAuthenticated ? (
        <Route path="/" element={<AdminLayout />}>
		  ...
		  <Route path="warehouse/addition" element={<WarehouseAddition />} />
